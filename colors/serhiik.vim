...
" :he group-name
" Any comment
hi Comment          term=italic     cterm=italic    ctermbg=NONE    ctermfg=245
" Any constant
hi Constant         term=NONE       cterm=NONE      ctermbg=NONE    ctermfg=NONE
" A string constant: 'this is a string'
hi String           term=NONE       cterm=NONE      ctermbg=NONE    ctermfg=082
" A character constant: 'c', '\n'
hi Character        term=NONE       cterm=NONE      ctermbg=NONE    ctermfg=082
...
hi Float            term=NONE       cterm=NONE      ctermbg=NONE    ctermfg=219
" Any variable name
hi Identifier       term=italic     cterm=italic    ctermbg=NONE    ctermfg=219
...
hi Conditional      term=bold       cterm=bold      ctermbg=NONE    ctermfg=226
" for, do, while, etc.
hi Repeat           term=bold       cterm=bold      ctermbg=NONE    ctermfg=214
" case, default, etc.
hi Label            term=italic     cterm=italic    ctermbg=NONE    ctermfg=219
" 'sizeof', '+', '*', etc.
hi Operator         term=NONE       cterm=NONE      ctermbg=NONE    ctermfg=214
" Any other keyword
hi Keyword          term=NONE       cterm=NONE      ctermbg=NONE    ctermfg=NONE
" try, catch, throw
hi Exception        term=bold       cterm=bold      ctermbg=NONE    ctermfg=009
...
" int, long, char, etc.
hi Type             term=italic     cterm=italic    ctermbg=NONE    ctermfg=045
...
hi Error            term=bold       cterm=bold      ctermbg=052     ctermfg=196
...
hi StatusLineNC     term=bold       cterm=bold      ctermbg=234     ctermfg=NONE
...
hi Visual           term=italic     cterm=italic    ctermbg=245     ctermfg=234
