...
colorscheme KuriletsS   " Кольорова схема
...
set hlsearch            " Підсвічування усіх збігів попереднього шаблону пошуку
...
set statusline=[B:%n]%2*%r%*[%F]%1*%m%*\ %=[Col:%2c][Line:%2l/%L][%2p%%]\ [%{&enc}]%y
